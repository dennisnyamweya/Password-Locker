...
##Check if users are instatianted correctly
    def setUp(self):
        ...
        '''
        self.new_user = User("James","Muriuki","zera","james") # create user object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.username,"zera")
        self.assertEqual(self.new_user.password,"james")
...
def test_find_user_by_name(self):
        ...
        found_user = User.find_by_name("zera")
